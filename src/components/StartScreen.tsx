...
export const StartScreen = ({ onSelectTournament, onSelectRaceBetting }: {
  ...
  <div className="w-full h-full relative">
    ...
    <div 
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 flex flex-col gap-8"
    >
      <button 
        onClick={onSelectRaceBetting} 
        className="pixel-font pixel-border w-full text-center pixel-btn transition-all duration-150 bg-[#e7f2eb] text-[#0f10f4] text-xl py-6"
      >
        RACE BETTING
      </button>
      <button 
